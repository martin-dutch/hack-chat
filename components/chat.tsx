  ...
  return (
    ...
    <Toolbar stage={3} title={`Round ${round + 1}/3`} />
      ...
      <div className="p-4">
        <div className="text-3xl font-bold">{`${'Trump'} - HQ`}</div>
          ...
          <div className="flex items-center w-full">
              ...
              />
              <h1 className="font-semibold text-[2vh]">{`${news.title}` || 'Trump destroys Deep State puppet Nikki to MAGA!'}</h1>
            </div>
      ...
      <div className="flex items-center w-full">
          ...
          {chat?.articles[round + 1]?.title != null && chat?.articles[round + 1]?.title?.length !== 0 && (<div className='w-[80vw] mx-auto'>
            <div className='mt-10'>
