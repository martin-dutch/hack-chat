...
const PollResults = ({progress}: {progress: number})=> {
...
//   }, [])
  ...
  <div className="font-medium text-gray-600 dark:text-gray-400">`{progress}% Haley`</div>
  ...
  <div className="font-medium text-gray-600 dark:text-gray-400">`{100 - progress}% Trump`</div>
</div></div>)
}
